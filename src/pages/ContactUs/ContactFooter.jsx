        ...
        <div className="relative z-10 p-8 md:p-16 lg:p-24 text-gray-800 flex-1">
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="mt-3">
              ...
              <p className="text-sm">
                <a href="tel:+97148735835" className="text-[#024959] hover:underline">+971 4 873 5835</a>
                <br />
                <a href="mailto:hello@gulfestates.ae" className="text-[#024959] hover:underline">hello@gulfestates.ae</a>
              </p>
            </div>
