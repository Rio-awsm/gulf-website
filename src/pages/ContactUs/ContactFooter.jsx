      ...
      <div className="flex flex-col md:flex-row h-full w-full">
        <div className="relative z-10 p-8 md:p-16 lg:p-24 text-gray-800 flex-1">
          ...
          <div className="mb-4">
            ...
            <p className="text-sm">
              {t('contact.footer.content.address')}
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-sm">{t('contact.footer.content.workingHours')}</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="mt-3">
              ...
              <p className="text-sm">
                <a href="tel:+97148735835" className="text-[#024959] hover:underline">
                  +971 4 873 5835
                </a>
                <br />
                <a href="mailto:hello@gulfestates.ae" className="text-[#024959] hover:underline">
