...
function LookFooter() {
  return (
    <section className="relative flex flex-col lg:flex-row items-start justify-end py-10 px-5 mt-14 lg:px-20">
      <div className="relative w-full lg:w-[39%] lg:pl-10 text-right mt-8 lg:mt-0 z-10 flex flex-col items-center">
        ...
        <button className="mt-6 lg:mt-8 bg-orange-500 text-white px-6 py-3">
          Read More
        </button>
      </div>
      <div
